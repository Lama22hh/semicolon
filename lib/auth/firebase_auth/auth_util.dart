...
DocumentReference? get currentUserReference =>
    loggedIn ? UserAccountRecord.collection.doc(currentUser!.uid) : null;

UserAccountRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UserAccountRecord.getDocument(UserAccountRecord.collection.doc(uid))
              .handleError((_) {}),
    )
