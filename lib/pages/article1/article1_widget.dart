...
import 'article1_model.dart';
export 'article1_model.dart';
...
class _Article1WidgetState extends State<Article1Widget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Article1Model());
  }
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              FlutterFlowWebView(
                content: 'https://www.ibm.com/topics/java',
                bypass: true,
                width: 393,
                height: 694,
                verticalScroll: true,
