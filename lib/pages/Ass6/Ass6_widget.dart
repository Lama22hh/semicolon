...
import 'ass6_model.dart';
export 'ass6_model.dart';

class Ass6Widget extends StatefulWidget {
  const Ass6Widget({Key? key}) : super(key: key);

  @override
  _Ass6WidgetState createState() => _Ass6WidgetState();
}

class _Ass6WidgetState extends State<Ass6Widget> {
  late Ass6Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Ass6Model());
